...
public class PaymentManager {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                if (response.statusCode() == 200) {
                    ...
                    String qrUrl = json.get("qr_code_url").getAsString();
    ...
    private static void sendPaymentLink(ServerPlayer player, String qrUrl, String orderId, int coins) {
        ...
        Component link = Component.literal(" [CLICK HERE TO PAY (WeChat)] ")
                ...
                .withStyle(style -> style
                        ...
                        .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal(qrUrl))));
